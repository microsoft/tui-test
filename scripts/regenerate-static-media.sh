...
The controller and monitor demos are recorded manually and are not changed.
EOF
}
...
echo "Regenerating GIF example..."
record_set recording 48 10 "$recording_script" recording.gif

echo "Static media regenerated in $static_dir"
echo "The controller and monitor demos were not modified."
