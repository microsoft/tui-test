...
class NativeSession:
    ...
    def __new__(cls, name: str, recording_mode: typing.Optional[str] = None, recording_directory: typing.Optional[str] = None, retention_count: typing.Optional[int] = None, retention_age_seconds: typing.Optional[int] = None, retention_size_bytes: typing.Optional[int] = None) -> NativeSession: ...
