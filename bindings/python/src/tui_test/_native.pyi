...
class NativeSession:
    ...
    def __new__(cls, name: str, recording_mode: typing.Optional[str] = None, recording_directory: typing.Optional[str] = None, monitoring_metadata: typing.Optional[str] = None) -> NativeSession: ...
