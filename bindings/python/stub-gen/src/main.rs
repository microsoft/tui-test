    ...
    pyo3_stub_gen::inventory::submit! {
        pyo3_stub_gen_derive::gen_methods_from_python! {
            ...
            class NativeSession:
                ...
                def wait_text_selector(self, selector_json: str, not_: bool, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def click_text(self, selector_json: str, button: int, clicks: int, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def highlight_text(self, selector_json: str, timeout_ms: typing.Optional[int]) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                def find_locator(self, query_json: str) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                def wait_locator(self, query_json: str, not_: bool, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def click_locator(self, query_json: str, button: int, clicks: int, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def highlight_locator(self, query_json: str, timeout_ms: typing.Optional[int]) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                def expect_locator(self, request_json: str, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
