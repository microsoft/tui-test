        ...
        pyo3_stub_gen_derive::gen_methods_from_python! {
            ...
            class NativeSession:
                def __new__(
                    ...
                    monitoring_metadata: typing.Optional[str] = None,
                ) -> NativeSession: ...
                ...
                def open(
                    ...
                    restart: bool,
                    profile_scrollback: typing.Optional[int],
                    profile_colors: typing.List[typing.Tuple[str, str]],
                ...
                def begin_monitor_wait(self, outcome: str, timeout_ms: typing.Optional[int], hold_while_attached: bool) -> typing.Tuple[str, int, str]: ...
                def wait_for_monitor(self, generation: int, timeout_ms: typing.Optional[int], hold_while_attached: bool) -> typing.Awaitable[bool]: ...
                def cancel_monitor_wait(self, generation: typing.Optional[int] = None) -> None: ...
                def close_monitor_target(self, generation: int) -> typing.Awaitable[None]: ...
                def state(self) -> typing.Awaitable[typing.Dict[str, typing.Any]]: ...
                def text(self, full: bool) -> typing.Awaitable[str]: ...
                def find_locator(self, stages: typing.List[typing.Dict[str, typing.Any]]) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                def wait_locator(self, stages: typing.List[typing.Dict[str, typing.Any]], not_: bool, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def click_locator(self, stages: typing.List[typing.Dict[str, typing.Any]], button: int, clicks: int, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def highlight_locator(self, stages: typing.List[typing.Dict[str, typing.Any]], timeout_ms: typing.Optional[int]) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                def expect_locator(self, stages: typing.List[typing.Dict[str, typing.Any]], not_: bool, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                ...
                def get_clipboard(self) -> typing.Awaitable[str]: ...
                ...
                def get_bell_events(self) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                ...
                def key_down(self, keys: typing.List[str]) -> typing.Awaitable[None]: ...
                def repeat(self, keys: typing.List[str]) -> typing.Awaitable[None]: ...
                def key_up(self, keys: typing.List[str]) -> typing.Awaitable[None]: ...
                def mouse_click(
                    self,
