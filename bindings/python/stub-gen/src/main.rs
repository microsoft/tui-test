        ...
        pyo3_stub_gen_derive::gen_methods_from_python! {
            ...
            class NativeSession:
                def __new__(
                    ...
                    artifact_directory: typing.Optional[str] = None,
                    artifact_mode: typing.Optional[str] = None,
                    artifact_include_recording: bool = False,
                    trace_mode: typing.Optional[str] = None,
                    trace_directory: typing.Optional[str] = None,
                ) -> NativeSession: ...
                ...
                def open(
                    ...
                    screen_history_limit: typing.Optional[int],
                ...
                def close(self, failed: typing.Optional[bool] = None) -> typing.Awaitable[None]: ...
                def state(self) -> typing.Awaitable[typing.Dict[str, typing.Any]]: ...
                def text(self, full: bool) -> typing.Awaitable[str]: ...
                def find_locator(self, expression: typing.Dict[str, typing.Any], require_one: bool) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                def wait_locator(self, expression: typing.Dict[str, typing.Any], not_: bool, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def click_locator(self, expression: typing.Dict[str, typing.Any], button: int, clicks: int, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
                def highlight_locator(self, expression: typing.Dict[str, typing.Any], timeout_ms: typing.Optional[int]) -> typing.Awaitable[typing.List[typing.Dict[str, typing.Any]]]: ...
                def expect_locator(self, expression: typing.Dict[str, typing.Any], not_: bool, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
