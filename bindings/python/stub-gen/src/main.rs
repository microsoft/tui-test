    ...
    pyo3_stub_gen::inventory::submit! {
        pyo3_stub_gen_derive::gen_methods_from_python! {
            ...
            class NativeSession:
                ...
                def expect_locator(self, stages: typing.List[typing.Dict[str, typing.Any]], style: typing.Dict[str, typing.Any], not_: bool, timeout_ms: typing.Optional[int]) -> typing.Awaitable[None]: ...
