...
const { NativeSession, Backend, closeAll, closeAllSync, LocatorNodeKind, LocatorStageDirection, recording, RecordingFormat, sessions, Shell, SnapshotResult, UnderlineStyle } = nativeBinding
export { NativeSession }
export { Backend }
export { closeAll }
export { closeAllSync }
export { LocatorNodeKind }
