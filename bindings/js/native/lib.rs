...
use tui_test::{
    ...
    EffectiveTimeouts as CoreEffectiveTimeouts, ErrorKind, MatchOccurrence as CoreMatchOccurrence,
    MouseAction, OpenOptions as CoreOpenOptions, OpenResult as CoreOpenResult, Operation,
    OperationResult, RunOptions as CoreRunOptions, ScreenshotResult as CoreScreenshotResult,
    SessionHandle, Size as CoreSize, SnapshotResult as CoreSnapshotResult, State as CoreState,
