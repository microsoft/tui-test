...
test("legacy errors do not substitute a live screenshot for requested exports", async () => {
  const originals = {
  ...
  try {
    ...
    await assert.rejects(
      ...
      (error) =>
        ...
        error.artifact.errors[0].includes("require native structured diagnostics") &&
