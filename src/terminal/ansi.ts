...
const specialKeyMap: Record<Key, { seq: string; modified: (mod: number) => string }> = {
  ...
  [Key.PageDown]: { seq: CSI + "6~",  modified: (m) => CSI + "6" + SEP + m + "~" },
  [Key.Insert]:   { seq: CSI + "2~",  modified: (m) => CSI + "2" + SEP + m + "~" },
  [Key.Delete]:   { seq: keyDelete,   modified: (m) => CSI + "3" + SEP + m + "~" },
  [Key.Backspace]:{ seq: keyBackspace, modified: (m) => m === 1 ? keyBackspace : CSI + "27" + SEP + m + SEP + "127~" },
  [Key.Tab]:      { seq: "\t",        modified: (m) => m === 1 ? "\t" : CSI + "27" + SEP + m + SEP + "9~" },
  [Key.Enter]:    { seq: "\r",        modified: (m) => m === 1 ? "\r" : CSI + "27" + SEP + m + SEP + "13~" },
  [Key.Space]:    { seq: " ",         modified: (m) => m === 1 ? " " : CSI + "27" + SEP + m + SEP + "32~" },
  [Key.Escape]:   { seq: ESC,         modified: (m) => m === 1 ? ESC : CSI + "27" + SEP + m + SEP + "27~" },
