...
| `screenshot [PATH] [--background COLOR \| --transparent]` | Read text or save SVG with a custom or transparent canvas. |
...
| Command | Use |
| --- | --- |
| `record start PATH [--background COLOR \| --transparent]` | Start a recording with a custom canvas. |
