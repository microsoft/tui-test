...
| `click text "T" [selector/style options]`                      | Auto-wait for one match and click its middle cell. Accepts the named button and modifier flags. |
...
tui-test click text "Save" --fg green --button right --ctrl  # auto-wait, then Ctrl-right-click
